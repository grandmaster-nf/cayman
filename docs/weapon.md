...
- **Le Monarque** - good for overload champions and void shields, poison reapplies the stun.
...
- **Eriana’s Vow** - excellent for barrier champs, but with snipers having AB this season, it’s not required and will free up the exotic slot for heavy weapons. Can be obtained from the exotic kiosk in the tower, catalyst adds auto-loading holster and bigger reserves. It’s a hand cannon that uses special ammo but shoots like a sniper, and works with hand cannon mods (except ammo finder).
- **Divinity** - best overload weapon for champions and also applies a damage debuff (35% but does not stack with tether debuff). Good synergy for Rocket launchers with Lasting Impression and excellent when paired with snipers like Izanagi for burst damage. Divinity creates a big crit spot on any enemy/boss, letting you snipe them with ease. Sundering Glare artifact mod stacks with it for additional 20% damage.
- **Izanagi’s Burden** - high burst sniper, especially when combined with Divinity (no need to aim). Can use the Anti-barrier mod this season, and should be paired with rocket launchers or machine guns. Honed Edge 4x delivers a lot of damage and can delete champions from range. Can be purchased from the exotic kiosk in the tower, catalyst adds bonus damage.
...
- **Rocket Launchers** - High burst for champions, ranged damage for bosses and also very good add-clear. Ideal for double primary or long range loadouts.
  - **Exotics**:
    - **Two-tailed Fox** or **Wardcliff Coil** for burst,
    - **Deathbringer** or **Eyes of Tomorrow** for add-clear.
  - **Legendary RL**:
    - For add-clear, look for high blast radius perks, Chain Reaction, Field Prep or Ambitious Assassin.
    - For high burst damage, look for velocity perks, Impact Casing, Lasting Impression, Auto-loading Holster or Clown Cartridge. Precision frame RL’s have intrinsic tracking, making them better than other archetypes.
...
- (Kinetic) True Prophecy - Gunsmith rank up drop (explosive payload)
![trueprophecy](https://grandmaster-nf.github.io/assets/images/trueprophecy.png)
- (Kinetic) Seventh Seraph Officer Revolver - World drop (timed payload or vorpal)
- (Kinetic) Crimil’s Dagger - Iron Banner drop (explosive payload)
- (Arc) Hand Cannon - Nation of Beasts (any roll with explosive payload) - Last Wish Raid
- (Arc) Waking Vigil (Rapid hit + Vorpal) - Dreaming City and Shattered Throne
